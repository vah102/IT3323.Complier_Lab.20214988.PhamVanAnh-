...
struct ErrorMessage errors[30] = {
  ...
  {ERR_TYPE_INCONSISTENCY, "Type inconsistency"},//nhập dấu trừ trước 1 ký tự, lệnh gán 0 tương ứng kiểu vt, vp kháckhác
  {ERR_PARAMETERS_ARGUMENTS_INCONSISTENCY, "The number of arguments and the number of parameters are inconsistent."}//truyền tham trị param valuevalue
};
